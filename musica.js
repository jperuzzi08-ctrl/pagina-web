const TRACK_SETS = [
  [
    { title: "Replica Autentica", src: "assets/music/replica-autentica.flac" },
...
const ARTISTS = [
  { title: "Riki", cover: "assets/music/riki.jpg", tracks: TRACK_SETS[0] },
  { title: "Good Kid", cover: "assets/music/goodkid2.jpg", tracks: TRACK_SETS[1] }
];
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  function renderArtists() {
    ...
    ARTISTS.forEach((artist, i) => {
      ...
      btn.innerHTML = `<img src="${artist.cover}" alt="Portada de ${artist.title}" onerror="this.replaceWith(Object.assign(document.createElement('div'),{className:'asset',textContent:'${artist.cover}'}))"><div class="album-title">${artist.title}</div>`;
